...
qshproto::qshproto(QObject *parent) : QObject(parent)
{
...
void qshproto::init()
{
    ...
    packet_tx = new shproto_struct { packet_buff_tx, sizeof(packet_buff_tx), 0, 0, 0, 0, 0, 0};
}


// add byte to buffer (with escaping)
void qshproto::shproto_packet_add_data(shproto_struct * shproto_packet, unsigned char tx_byte) {
...
void qshproto::shproto_packet_start(shproto_struct * shproto_packet, unsigned char cmd) {
...
unsigned short qshproto::shproto_packet_complete(shproto_struct * shproto_packet) {
...
void qshproto::shproto_byte_received(shproto_struct * shproto_packet, unsigned char rx_byte) {
    switch (rx_byte) {
    case SHPROTO_START:
